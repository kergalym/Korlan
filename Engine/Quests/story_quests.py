...
class StoryQuests:
    def __init__(self, social_quests):
        ...
        self._started_quest_sleeping_inside_yurt = False
    ...
    def start_story_mode_task(self, task):
        ...
        if self.base.game_instance['loading_is_done'] == 1:
            if not self._started_quest_sleeping_inside_yurt:
                self.start_quest_sleeping_inside_yurt()
        return task.cont
    ...
    def start_quest_sleeping_inside_yurt(self):
        """ Korlan wakes up inside yurt and see... """
        self._started_quest_sleeping_inside_yurt = True
